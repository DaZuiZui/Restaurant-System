...
public interface MenuMapper {
     ...
     * @param menuType
     */
    @Insert("insert into menu values(null,#{menu},#{image},#{flavor},#{introduce},#{menuData},#{menuMake},#{foodtimes},#{menutype})")
     ...
     * 通过id查询指定菜系
     */
    @Select("select *from menu where menu like '%' #{menu} '%' ")
    public ArrayList<Menu> queryByMenumenu(@Param("menu")String menu);
